...
voice "c-10-9.wav" #Stacey (Ashe Thurman)
sta "Was okay. Seen better. Seen worse, too."

voice "c-10-10.wav" #Yumi (Kathy Pfautsch)
yum "Huh. Doesn't seem like the others really thought that way."

voice "c-10-11.wav" #Stacey (Ashe Thurman)
...
voice "c-10-17.wav" #Yumi (Kathy Pfautsch)
yum "You mean fifty cents right?"

voice "c-10-18.wav" #Stacey (Ashe Thurman)
sta "No."

voice "c-10-19.wav" #Yumi (Kathy Pfautsch)
yum "Okay, there has to be a story there. Tell me that first."

voice "c-10-20.wav" #Stacey (Ashe Thurman)
...
voice "c-10-21.wav" #Stacey (Ashe Thurman)
...
voice "c-10-30.wav" #Yumi (Kathy Pfautsch)
yum "She called it her {i}pheromones.{/i}"

voice "c-10-31.wav" #Stacey (Ashe Thurman)
sta "So sweat, then. Except she used the kinky word for it. So pretentious..."

voice "c-10-32.wav" #Yumi (Kathy Pfautsch)
yum "{i}Right?!{/i} I- Wait, no. That's not the problem here!"

voice "c-10-33.wav" #Stacey (Ashe Thurman)
sta "Oh. Sorry. You were venting, so I was trying to be supportive."

voice "c-10-34.wav" #Yumi (Kathy Pfautsch)
yum "I think I'm good without that."

voice "c-10-35.wav" #Stacey (Ashe Thurman)
sta "Got it."

voice "c-10-36.wav" #Yumi (Kathy Pfautsch)
yum "So anyways, the {i}next{/i} thing-"

voice "c-10-37.wav" #Stacey (Ashe Thurman)
...
voice "c-10-38.wav" #Yumi (Kathy Pfautsch)
yum "Stacey. You're not helping."

voice "c-10-39.wav" #Stacey (Ashe Thurman)
sta "You said not to. I'm sorta getting mixed signals here."

voice "c-10-40.wav" #Yumi (Kathy Pfautsch)
yum "Just let me finish. {i}Then{/i} be supportive. Alright?"

voice "c-10-41.wav" #Stacey (Ashe Thurman)
sta "Yes, ma'am."

voice "c-10-42.wav" #Yumi (Kathy Pfautsch)
...
voice "c-10-43.wav" #Stacey (Ashe Thurman)
sta "Oof. World domination? She doesn't think that's a little tacky?"

voice "c-10-44.wav" #Yumi (Kathy Pfautsch)
yum "Not at all! She even tried to make me her minion!"

voice "c-10-45.wav" #Stacey (Ashe Thurman)
sta "Whoah. Wait wait wait. Is 'minion' her choice of words? Or yours."

voice "c-10-46.wav" #Yumi (Kathy Pfautsch)
yum "{i}Hers,{/i} obviously. What do I look like, some kind of loser?"

"She takes uncomfortably long to respond."

voice "c-10-47.wav" #Stacey (Ashe Thurman)
sta "Okay. So she's definitely tacky, but at least she's owning it? Commitment's cool. I give iiiiit... a twelve?"

voice "c-10-48.wav" #Yumi (Kathy Pfautsch)
yum "Stacey."

voice "c-10-49.wav" #Stacey (Ashe Thurman)
sta "Sorry."

voice "c-10-50.wav" #Yumi (Kathy Pfautsch)
yum "And then she had the gall to just sneak up on me in the middle of the night-"

voice "c-10-51.wav" #Stacey (Ashe Thurman)
sta "Oh this cannot end well."

voice "c-10-52.wav" #Yumi (Kathy Pfautsch)
yum "-and started to cuddle me!"

voice "c-10-53.wav" #Stacey (Ashe Thurman)
sta "I stand corrected."

voice "c-10-54.wav" #Yumi (Kathy Pfautsch)
yum "It's creepy! I am {i}not{/i} putting up with that kind of bullshit!"

voice "c-10-55.wav" #Stacey (Ashe Thurman)
sta "Maybe she thought you were cold?"

voice "c-10-56.wav" #Yumi (Kathy Pfautsch)
yum "She could have used a blanket!"

voice "c-10-57.wav" #Stacey (Ashe Thurman)
sta "Yeah but that's way less kinky."

voice "c-10-58.wav" #Yumi (Kathy Pfautsch)
yum "{i}That's the problem!{/i}"

voice "c-10-59.wav" #Stacey (Ashe Thurman)
sta "Oh."

voice "c-10-60.wav" #Stacey (Ashe Thurman)
sta "Okay, so lemme get this straight. You're saying you're frustrated because your roommate is smelly, doesn't accept responsibility, is a teensy bit evill, and doesn't respect your personal space."

voice "c-10-61.wav" #Yumi (Kathy Pfautsch)
yum "Yes! Exactly. Outside of the 'teensy' part."

voice "c-10-62.wav" #Stacey (Ashe Thurman)
...
voice "c-10-69.wav" #Stacey (Ashe Thurman)
...
voice "c-10-74.wav" #Stacey (Ashe Thurman)
...
voice "c-10-93.wav" #Stacey (Ashe Thurman)
sta "Yeah, see? I knew you'd get it. You're pretty smart like that."

voice "c-10-94.wav" #Yumi (Kathy Pfautsch)
yum "You're too kind."

voice "c-10-95.wav" #Stacey (Ashe Thurman)
